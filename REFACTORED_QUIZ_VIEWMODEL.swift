...
// MARK: - Refactored Haptic Manager
class RefactoredHapticManager: HapticManagerProtocol {
    ...
    private func isHapticEnabled() -> Bool {
        return settingsManager.settings.hapticEnabled
    }
...
// MARK: - Refactored Sound Manager
class RefactoredSoundManager: SoundManagerProtocol {
    private let settingsManager: SettingsManagerProtocol
    ...
    private func isSoundEnabled() -> Bool {
        return settingsManager.settings.soundEnabled
    }
    
    func playSuccessSound() {
        guard isSoundEnabled() else { return }
        playSystemSound(AppConstants.SystemSounds.success)
    }
    
    func playErrorSound() {
        guard isSoundEnabled() else { return }
        playSystemSound(AppConstants.SystemSounds.error)
    }
    
    func playSelectionSound() {
        guard isSoundEnabled() else { return }
        playSystemSound(AppConstants.SystemSounds.selection)
    }
